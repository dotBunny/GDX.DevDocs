...
namespace Dox.Steps.Templates
{
    public class Footer : IStep
    {
        ...
        public void Process()
        {
            ...
            generator.Append($"<span>Built on {Config.ShortDate} against <a href=\"{Config.GitCommit}{commit}\"><strong>{shortCommit}</strong></a>.<br />Generated by <a href=\"{Config.DoxUri}\"><strong>Dox</strong></a> &#38; <a href=\"{Config.DocFxUri}\"><strong>DocFX</strong></a>.</span>");
            generator.Append("{{/_appFooter}}");
            generator.NextLine();
