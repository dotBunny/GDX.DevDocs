...
echo [1m[36m^> Create License[0m

set TARGET=%~dp0..\..\..\Projects\GDX_Development\Packages\com.dotbunny.gdx\.docfx\license.md
...
echo --- >> %TARGET%
type %~dp0..\..\..\Projects\GDX_Development\Packages\com.dotbunny.gdx\LICENSE >> %TARGET%