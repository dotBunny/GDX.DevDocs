...
set TARGET=%~dp0..\..\..\Projects\000_Development\Assets\com.dotbunny.gdx\.docfx\manual\contributing\code-of-conduct.md

echo --- > %TARGET%
echo _disableContribution: true >> %TARGET%
echo --- >> %TARGET%
type %~dp0..\..\..\Projects\000_Development\Assets\com.dotbunny.gdx\CODE_OF_CONDUCT.md >> %TARGET%